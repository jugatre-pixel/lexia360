...
# Hash robusto, sin límite 72 bytes (evita problemas de bcrypt)
...
# 🔴 MUY IMPORTANTE:
# Para evitar que /inmuebles/{id} capture "trash" y cause 422,
# define rutas fijas como /inmuebles/trash ANTES de /inmuebles/{id_inmueble}.
